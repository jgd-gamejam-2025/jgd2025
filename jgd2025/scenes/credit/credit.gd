...
func next_step() -> void:
	...
	if input_received == 1:
		...
		terminal.write_art_sync(eve_corner, terminal.special_label, 10000)
	
		await terminal.write_line("                                                                                          制作", 0.002).finished
		await terminal.write_line("                                                                                          人名", 0.002).finished
		terminal.write_line_static("\n\n\n\n\n\n\n\n\n\n\n")
		# terminal.write_art_sync(eve_fal.special_label2, 10000, true)
